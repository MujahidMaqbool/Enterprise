...
import { ViewRole, RoleModuleList, RoleModulePageList } from '../models/roles.model';
...
export class RoleViewComponent implements OnInit {
 ...
 viewModulePageList:RoleModulePageList;
  ...
  viewRole(roleID: number) {
    ...
    let url = StaffApi.detail.replace("{roleID}", roleID.toString());
  ...
  setViewToleDetail(Result: any) {
    ...
    this.viewRoleDetail.Description = Result.Description;
